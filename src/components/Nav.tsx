    ...
    <nav className="nav">
      <div className="container glass nav-inner">
        <div style={{display:"flex", alignItems:"center", gap:"0.9rem"}}>
          <span aria-hidden className="kbd" style={{background:"linear-gradient(90deg,#9881fc,#3b82f6)", WebkitBackgroundClip:"text", color:"transparent", fontSize:32, fontWeight:800}}>STEGI56</span>
        </div>
